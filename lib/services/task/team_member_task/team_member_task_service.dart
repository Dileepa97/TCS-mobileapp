...
class TeamMemberTaskService {
  ...
  static Future<List<Task>> getOngoingTasks(String teamMemberID) async {
    ...
    var body = jsonEncode({"teamMemberId": teamMemberID});

    http.Response response = await http
        .post(apiEndpoint + "team-member-task/ongoing",
            headers: {
  ...
  static Future<List<Task>> getPartiallyCompletedTasks(
    ...
    http.Response response = await http
        .post(apiEndpoint + "team-member-task/partially-completed",
            headers: {
              "Accept": "application/json",
              "content-type": "application/json"
            },
  ...
  static Future<List<Task>> getCompletedTasks(String teamMemberID) async {
    ...
    http.Response response = await http
        .post(apiEndpoint + "team-member-task/completed",
            headers: {
              "Accept": "application/json",
              "content-type": "application/json"
            },
