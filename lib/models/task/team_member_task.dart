...
class TeamMemberTask {
  ...
  factory TeamMemberTask.formJson(Map<String, dynamic> data) {
    return TeamMemberTask(
        ...
        pickedAt: data['pickedAt'] == null
            ? null
            : DateTime.parse(data['pickedAt'] as String),
        startAt: data['startTime'] == null
            ? null
            : DateTime.parse(data['startTime'] as String),
        updateAt: data['updatedTime'] == null
            ? null
            : DateTime.parse(data['updatedTime'] as String),
