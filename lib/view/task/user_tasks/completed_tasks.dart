...
class _UserCompletedTasksState extends State<UserCompletedTasks> {
  ...
  Future getCompletedTasks() async {
    dynamic tasks =
        await TeamMemberTaskService.getCompletedTasks(widget.userId);
    setState(() {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              this.completedTaskList[index].teamMemberTask.taskName,
              style: TextStyle(
                fontSize: 20,
            ...
            SizedBox(height: 8),
            Text(
              this.completedTaskList[index].customer.organizationName,
              style: TextStyle(
                fontSize: 15,
                color: Colors.black87,
                fontFamily: 'Arial',
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
                "Started at " +
                    DateFormat('yyyy-MM-dd – kk:mm')
                        .format(this.completedTaskList[index].startAt),
                style: TextStyle(
                  fontSize: 15,
                  color: Colors.black87,
                  fontFamily: 'Arial',
            ...
            Text(
                "Completed at " +
                    DateFormat('yyyy-MM-dd – kk:mm')
                        .format(this.completedTaskList[index].endTime),
                style: TextStyle(
                  fontSize: 15,
                  color: Colors.black87,
                  fontFamily: 'Arial',
  ...
  Widget taskCard(BuildContext context, dynamic index) {
    ...
    return Container(
      ...
      child: InkWell(
        ...
        child: Column(
          children: [cardTop(context, index), cardBottom(context, index)],
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: SideDrawer(),
      body: (this.completedTaskList.length == 0 || this.completedTaskList == 1)
          ? Container(
              padding:
