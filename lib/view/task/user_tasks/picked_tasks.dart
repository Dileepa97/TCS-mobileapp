...
class _UserPickedTasksState extends State<UserPickedTasks> {
        ...
        child: Row(
          children: [
            Column(
              ...
              children: [
                Text(
                  this.pickedTaskList[index].teamMemberTask.taskName,
                  style: TextStyle(
                    fontSize: 20,
                ...
                SizedBox(height: 8),
                Text(
                  this.pickedTaskList[index].customer.organizationName,
                  style: TextStyle(
                    fontSize: 15,
                    color: Colors.black87,
                    fontFamily: 'Source Sans Pro',
            ...
            Text(
                "Picked at " +
                    DateFormat('yyyy-MM-dd – kk:mm')
                        .format(this.pickedTaskList[index].pickedAt),
                style: TextStyle(
                  fontSize: 15,
                  color: Colors.black87,
                  fontFamily: 'Source Sans Pro',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: SideDrawer(),
      body: (this.pickedTaskList.length == 0 || this.pickedTaskList == 1)
          ? Container(
              padding:
